...
@LargeTest
public class MainActivityNotFoundItemsTest {
    ...
    @Test
    public void mainActivityNotFoundItems() {
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withId(R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("não encontar dados"), closeSoftKeyboard());
